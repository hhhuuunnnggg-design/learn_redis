...
// @Service
// public class ProductLocalCacheTemplate extends CacheTemplate<Integer,
// Product> {
...
// LocalCachedMapOptions<Integer, Product> mapOptions =
// LocalCachedMapOptions.<Integer, Product>defaults()
// .syncStrategy(LocalCachedMapOptions.SyncStrategy.UPDATE)
// .reconnectionStrategy(LocalCachedMapOptions.ReconnectionStrategy.CLEAR);
// this.map = client.getLocalCachedMap("product", new
// TypedJsonJacksonCodec(Integer.class, Product.class),
// mapOptions);
// }
